...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		Hint = syntax_entry(palette.bg2, palette.none),
		...
		NormalFloat = syntax_entry(palette.grey10, palette.bg2),
		...
		Builtin = syntax_entry(palette.grey2, palette.none, optional_italics),
		...
		Function = syntax_entry(palette.grey11, palette.none),
		...
		Identifier = syntax_entry(palette.grey8, palette.none),
		...
		Type = syntax_entry(palette.grey3, palette.none),
		Typedef = syntax_entry(palette.grey3, palette.none, optional_italics),
		Macro = syntax_entry(palette.red, palette.none),
		SpecialComment = syntax_entry(palette.grey4, palette.none, comment_italics),
		...
		WhichKeyFloat = syntax_entry(palette.none, palette.bg3),
		...
		-- hrsh7th/nvim-cmp
		CmpItemAbbrMatch = syntax_entry(palette.pinkdark, palette.none, { styles.bold }),
		...
		-- phaazon/hop.nvim
		HopNextKey = syntax_entry(palette.bg0, palette.pinklight, { styles.bold }),
		HopNextKey1 = syntax_entry(palette.bg0, palette.pinklight, { styles.bold }),
