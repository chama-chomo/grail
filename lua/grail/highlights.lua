...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		Search = syntax_entry(palette.fg, palette.bg5),
		...
		LineNr = syntax_entry(palette.bg4, palette.none),
		Hint = syntax_entry(palette.bg3, palette.none),
		CursorLineNr = syntax_entry(palette.green3, palette.none),
		...
		Directory = syntax_entry(palette.green3, palette.none),
		...
		MatchParen = syntax_entry(palette.orange, palette.bg1),
		...
		Visual = syntax_entry(palette.none, palette.bg_yellow),
		VisualNOS = syntax_entry(palette.none, palette.bg_green),
		...
		Builtin = syntax_entry(palette.blue4, palette.none, optional_italics),
		Character = syntax_entry(palette.green, palette.none),
		Constant = syntax_entry(palette.statusline1, palette.none),
		Field = syntax_entry(palette.grey9, palette.none),
		Function = syntax_entry(palette.grey10, palette.none),
		FunctionDecl = syntax_entry(palette.grey10, palette.none),
		FunctionKeywordDecl = syntax_entry(palette.orange, palette.bg_yellow, optional_italics),
		...
		Identifier = syntax_entry(palette.grey9, palette.none),
		Variable = syntax_entry(palette.grey8, palette.none),
		...
		Comment = syntax_entry(palette.grey2, palette.none, comment_italics),
		Exception = syntax_entry(palette.pink1, palette.none, optional_italics),
		Statement = syntax_entry(palette.grey5, palette.none, optional_italics),
		...
		Operator = syntax_entry(palette.grey9, palette.none),
		...
		Type = syntax_entry(palette.grey6, palette.none),
		Typedef = syntax_entry(palette.grey4, palette.none, optional_italics),
		...
		Ignore = syntax_entry(palette.grey2, palette.none),
		...
		Red = syntax_entry(palette.pink1, palette.none),
		...
		Aqua = syntax_entry(palette.blue, palette.none),
		Blue = syntax_entry(palette.blue4, palette.none),
		...
		CurrentWord = syntax_entry(palette.none, palette.bg3),
		-- Git commit colours
		...
		TelescopeMatching = syntax_entry(palette.red, palette.none, { styles.bold }),
		...
		MiniIndentscopeSymbol = { link = "Hint" },
