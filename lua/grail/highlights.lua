...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		Boolean = syntax_entry(palette.pink1, palette.none),
		Builtin = syntax_entry(palette.yellow, palette.none, optional_italics),
		Character = syntax_entry(palette.green, palette.none),
		Constant = syntax_entry(palette.grey5, palette.none),
		...
		Identifier = syntax_entry(palette.grey4, palette.none),
		Define = syntax_entry(palette.purple, palette.none, optional_italics),
		Conditional = syntax_entry(palette.grey2, palette.none, optional_italics),
		Comment = syntax_entry(palette.grey, palette.none, comment_italics),
		Repeat = syntax_entry(palette.pink1, palette.none, optional_italics),
		...
		Typedef = syntax_entry(palette.blue2, palette.none, optional_italics),
