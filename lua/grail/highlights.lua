...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		NormalNC = syntax_entry(palette.grey2, colour_respecting_options(palette.bg0)),
		Terminal = syntax_entry(palette.grey2, colour_respecting_options(palette.bg0)),
		...
		Boolean = syntax_entry(palette.red, palette.none),
		...
		Field = syntax_entry(palette.grey5, palette.none),
		...
		Identifier = syntax_entry(palette.grey6, palette.none),
		Define = syntax_entry(palette.purple, palette.none, optional_italics),
		Conditional = syntax_entry(palette.yellow, palette.none, optional_italics),
		Repeat = syntax_entry(palette.yellow, palette.none, optional_italics),
		...
		Statement = syntax_entry(palette.grey4, palette.none, optional_italics),
		...
		Operator = syntax_entry(palette.grey8, palette.none),
		...
		Type = syntax_entry(palette.reddull, palette.none),
		Typedef = syntax_entry(palette.reddull, palette.none, optional_italics),
		...
		Fg = syntax_entry(palette.grey7, palette.none),
		...
		Blue = syntax_entry(palette.blue5, palette.none),
		...
		VirtualTextWarning = { link = "Comment" },
		VirtualTextError = { link = "Error" },
		VirtualTextInfo = { link = "Comment" },
		...
		CurrentWord = syntax_entry(palette.none, palette.bg2, { styles.bold }),
		-- Git commit colours
