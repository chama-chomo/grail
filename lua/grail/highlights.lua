...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		MatchParen = syntax_entry(palette.bg1, palette.grey5),
		...
		Include = syntax_entry(palette.pink1, palette.none, optional_italics),
		...
		Comment = syntax_entry(palette.grey, palette.none, comment_italics),
		...
		Type = syntax_entry(palette.yellowgrey, palette.none),
		...
		CurrentWord = syntax_entry(palette.none, palette.bg_yellow),
		-- Git commit colours
		...
		TelescopeMatching = syntax_entry(palette.grey11, palette.bg1, { styles.bold }),
