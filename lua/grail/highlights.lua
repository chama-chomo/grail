...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		Include = syntax_entry(palette.yellow, palette.none, optional_italics),
		...
		Type = syntax_entry(palette.grey4, palette.none),
		...
		TelescopeMatching = syntax_entry(palette.pinkdark, palette.none, { styles.bold }),
