...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		...
		NormalNC = syntax_entry(palette.grey7, colour_respecting_options(palette.bg0)),
		Terminal = syntax_entry(palette.grey4, colour_respecting_options(palette.bg0)),
		...
		Search = syntax_entry(palette.fg, palette.bg_visual),
		...
		LineNr = syntax_entry(palette.bg3, palette.none),
		Hint = syntax_entry(palette.bg5, palette.none),
		CursorLineNr = syntax_entry(palette.grey2, palette.none),
		...
		Directory = syntax_entry(palette.blue5, palette.none),
		ErrorMsg = syntax_entry(palette.pinkdark, palette.none, { styles.bold, styles.underline }),
		WarningMsg = syntax_entry(palette.orange, palette.none, { styles.bold }),
		ModeMsg = syntax_entry(palette.fg, palette.none, { styles.bold }),
		MoreMsg = syntax_entry(palette.yellow, palette.none, { styles.bold }),
		MatchParen = syntax_entry(palette.orange, palette.bg2),
		...
		FloatBorder = syntax_entry(palette.grey6, palette.bg2),
		Question = syntax_entry(palette.yellow, palette.none),
		SpellBad = syntax_entry(palette.none, palette.none, { styles.undercurl }, palette.pink1),
		...
		StatusLine = syntax_entry(
			palette.grey8,
			options.transparent_background_level == 2 and palette.none or palette.bg3
		),
		...
		debugBreakpoint = syntax_entry(palette.bg0, palette.pink1),
		...
		Attribute = syntax_entry(palette.pink1, palette.none),
		Boolean = syntax_entry(palette.blue1, palette.none),
		Builtin = syntax_entry(palette.redlight, palette.none, optional_italics),
		Character = syntax_entry(palette.green, palette.none),
		Constant = syntax_entry(palette.statusline1, palette.none),
		Field = syntax_entry(palette.grey7, palette.none),
		Function = syntax_entry(palette.grey9, palette.none),
		FunctionDecl = syntax_entry(palette.grey9, palette.none),
		FunctionKeywordDecl = syntax_entry(palette.orange, palette.bg2, optional_italics),
		Keyword = syntax_entry(palette.orange, palette.none, optional_italics),
		...
		Include = syntax_entry(palette.orange, palette.none, optional_italics),
		Identifier = syntax_entry(palette.grey7, palette.none),
		Variable = syntax_entry(palette.grey7, palette.none),
		Define = syntax_entry(palette.orange, palette.none, optional_italics),
		Conditional = syntax_entry(palette.orange, palette.none, optional_italics),
		Repeat = syntax_entry(palette.orange, palette.none, optional_italics),
		Comment = syntax_entry(palette.bg_violet, palette.none, comment_italics),
		Exception = syntax_entry(palette.pink1, palette.none, optional_italics),
		Statement = syntax_entry(palette.grey7, palette.none, optional_italics),
		Error = syntax_entry(palette.pink1, palette.none),
		...
		Float = syntax_entry(palette.green3, palette.none),
		Number = syntax_entry(palette.green3, palette.none),
		Structure = syntax_entry(palette.yellow, palette.none),
		Operator = syntax_entry(palette.grey7, palette.none),
		Title = syntax_entry(palette.orange, palette.none, { styles.bold }),
		Special = syntax_entry(palette.yellowlight, palette.none),
		SpecialChar = syntax_entry(palette.yellowlight, palette.none),
		String = syntax_entry(palette.blue1, palette.none),
		Type = syntax_entry(palette.grey7, palette.none),
		Typedef = syntax_entry(palette.grey7, palette.none, optional_italics),
		Macro = syntax_entry(palette.red, palette.none),
		SpecialComment = syntax_entry(palette.grey5, palette.none, comment_italics),
		Todo = syntax_entry(palette.purple, palette.none, comment_italics),
		Delimiter = syntax_entry(palette.fg, palette.none),
		Ignore = syntax_entry(palette.grey4, palette.none),
		Underlined = syntax_entry(palette.none, palette.none, { styles.underline }),
		-- Predefined highlight groups
		Fg = syntax_entry(palette.fg, palette.none),
		Grey = syntax_entry(palette.grey6, palette.none),
		F = syntax_entry(palette.blue2, palette.none),
		Red = syntax_entry(palette.red, palette.none),
		Orange = syntax_entry(palette.orange, palette.none),
		BlameClr = syntax_entry(palette.grey2, palette.bg3),
		...
		Brown = syntax_entry(palette.fgdark, palette.none),
		Purple = syntax_entry(palette.purple, palette.none),
		RedItalic = syntax_entry(palette.pink1, palette.none, optional_italics),
		...
		AquaItalic = syntax_entry(palette.blue, palette.none, optional_italics),
		BlueItalic = syntax_entry(palette.blue5, palette.none, optional_italics),
		...
		RedSign = syntax_entry(palette.pink1, colour_respecting_options(palette.bg0)),
		OrangeSign = syntax_entry(palette.orange, colour_respecting_options(palette.bg0)),
		YellowSign = syntax_entry(palette.yellow, colour_respecting_options(palette.bg0)),
		GreenSign = syntax_entry(palette.green, colour_respecting_options(palette.bg0)),
		AquaSign = syntax_entry(palette.aqua, colour_respecting_options(palette.bg0)),
		...
		VirtualTextWarning = { link = "Blue" },
		VirtualTextError = { link = "Error" },
		VirtualTextInfo = { link = "Fg" },
		VirtualTextHint = { link = "Orange" },
		ErrorFloat = syntax_entry(palette.pink1, palette.bg2),
		...
		CurrentWord = syntax_entry(palette.none, palette.bg2),
		-- Git commit colours
		...
		helpHeadline = syntax_entry(palette.pink1, palette.none, { styles.bold }),
		...
		TSDanger = syntax_entry(palette.bg0, palette.pink1, { styles.bold }),
		...
		TSPunctSpecial = { link = "Type" },
		TSRepeat = { link = "Repeat" },
		TSStorageClass = { link = "Structure" },
		TSStorageClassLifetime = { link = "Orange" },
		TSStrike = { link = "Grey" },
		TSString = { link = "String" },
		TSStringEscape = { link = "Yellow" },
		TSStringRegex = { link = "Yellow" },
		TSStringSpecial = { link = "Blue" },
		...
		tomlKey = { link = "Identifier" },
		tomlString = { link = "Green" },
		...
		-- p00f/ts-rainbow
		rainbowcol1 = syntax_entry(palette.pink1, palette.none),
		...
		lspInlayHint = { link = "Hint" },
		lspInlayHintsType = { link = "Hint" },
		lspInlayHintsParameter = { link = "Hint" },
		...
		WhichKey = syntax_entry(palette.pinkdark, palette.none),
		WhichKeyDesc = syntax_entry(palette.grey8, palette.none),
		WhichKeyFloat = syntax_entry(palette.none, palette.bg2),
		WhichKeyGroup = syntax_entry(palette.orangedull, palette.none),
		WhichKeySeparator = { link = "Fg" },
		WhichKeyValue = syntax_entry(palette.fgdark, palette.none),
		...
		TelescopeMatching = syntax_entry(palette.redlight, palette.none, { styles.bold }),
		TelescopeBorder = syntax_entry(palette.fg, palette.bg_dim),
		-- TelescopeNormal = { link = "Fg" },
		TelescopeNormal = syntax_entry(palette.fg, palette.bg_dim),
		...
		GitSignsCurrentLineBlame = { link = "BlameClr" },
		-- phaazon/hop.nvim
		...
		HopNextKey2 = syntax_entry(palette.redlight, palette.none, { styles.bold }),
		...
		IndentBlanklineContextChar = syntax_entry(palette.bg4, palette.none, { styles.nocombine }),
		IndentBlanklineChar = syntax_entry(palette.bg2, palette.none, { styles.nocombine }),
		...
		BufferCurrentTarget = syntax_entry(palette.pink1, palette.bg0, { styles.bold }),
		...
		MiniTestFail = syntax_entry(palette.pink1, palette.none, { styles.bold }),
		MiniTestPass = syntax_entry(palette.green, palette.none, { styles.bold }),
		MiniTrailspace = syntax_entry(palette.none, palette.pink1),
		...
		LightspeedLabel = syntax_entry(palette.pink1, palette.none, { styles.bold, styles.underline }),
		LightspeedLabelDistant = syntax_entry(palette.blue, palette.none, { styles.bold, styles.underline }),
		LightspeedShortcut = syntax_entry(palette.bg0, palette.pink1, { styles.bold }),
		...
		OctoRedFloat = syntax_entry(palette.pink1, palette.bg2),
		...
		OctoBubbleRed = syntax_entry(palette.bg0, palette.pink1),
		...
		-- treesitter-context
		TreesitterContext = syntax_entry(palette.fg, palette.bg2, { styles.bold }),
		TreesitterContextSeparator = syntax_entry(palette.grey2, palette.bg0, { styles.bold }),
		-- mbbill/undotree
		...
		NeotestFailed = syntax_entry(palette.pink1, palette.none),
		...
		GlyphPalette1 = syntax_entry(palette.pink1, palette.none),
		...
		GlyphPalette9 = syntax_entry(palette.pink1, palette.none),
		...
		ScrollbarErrorHandle = syntax_entry(palette.pink1, palette.bg1),
		ScrollbarError = syntax_entry(palette.pink1, palette.none),
		...
		-- Markdown
		markdownH1 = syntax_entry(palette.pink1, palette.none, { styles.bold }),
		...
		-- HTML
		htmlH1 = syntax_entry(palette.pink1, palette.none, { styles.bold }),
		...
		goPredefinedIdentifiers = { link = "Grey" },
	...
	if options.transparent_background_level == 0 then
		...
		syntax["NeoTreeNormal"] = syntax_entry(palette.grey11, palette.bg_dim)
