...
highlights.generate_syntax = function(palette, options)
	...
	local syntax = {
		Normal = syntax_entry(palette.grey10, colour_respecting_options(palette.bg0)),
		...
		Hint = syntax_entry(palette.blue2, palette.none),
		...
		Boolean = syntax_entry(palette.blue4, palette.none),
		Builtin = syntax_entry(palette.grey1, palette.none, optional_italics),
		Character = syntax_entry(palette.green, palette.none),
		Constant = syntax_entry(palette.blue4, palette.none),
		...
		Variable = syntax_entry(palette.grey6, palette.none),
		...
		Comment = syntax_entry(palette.yellowgrey, palette.none, comment_italics),
		Exception = syntax_entry(palette.pink1, palette.none, optional_italics),
		Statement = syntax_entry(palette.grey6, palette.none, optional_italics),
		...
		Fg = syntax_entry(palette.grey6, palette.none),
		Grey = syntax_entry(palette.grey3, palette.none),
		...
		TelescopeMatching = syntax_entry(palette.grey10, palette.none, { styles.bold }),
